...
class AvatarToken extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double chainLogoSize = chainLogoWidth ?? chainLogoHeight ?? 24.w;
                  ...
                  child: ClipOval(
                    child: chainLogoWidget != null
                        ...
                        : FeatureImage(
                            ...
                            height: chainLogoSize,
                            fit: BoxFit.cover,
                            errorWidget: _buildChainLogoPlaceholder(
                              context,
                              chainLogoSize,
                            ),
                          ),
  ...
  Widget _buildChainLogoPlaceholder(
    BuildContext context,
    double chainLogoSize,
  ) {
    return ClipOval(
      child: Container(
        width: chainLogoSize,
