...
class IntelSearchBarWidget extends StatefulWidget {
  const IntelSearchBarWidget({
    super.key,
  ...
  @override
  State<IntelSearchBarWidget> createState() => _IntelSearchBarWidgetState();
}

class _IntelSearchBarWidgetState extends State<IntelSearchBarWidget> {
  @override
