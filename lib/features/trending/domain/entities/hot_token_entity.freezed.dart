...
switch (_that) {
case _HotTokenEntity():
return $default(_that.name,_that.symbol,_that.logo,_that.marketCap,_that.decimals,_that.price,_that.contractAddress,_that.chainId,_that.chainName,_that.chainLogo,_that.network,_that.slug,_that.chainIndex);}
}
