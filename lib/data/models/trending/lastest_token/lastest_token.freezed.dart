...
mixin _$LatestToken {
  ...
  @JsonKey(name: 'standard', defaultValue: '')
...
class _$LatestTokenImpl implements _LatestToken {
  const _$LatestTokenImpl(
      ...
      @JsonKey(name: 'volume_24h', defaultValue: 0) this.volume24h,
      @JsonKey(name: 'market_cap', defaultValue: 0) this.marketCap,
      @JsonKey(name: 'price_usd', defaultValue: 0) this.priceUsd,
      @JsonKey(name: 'is_verified', defaultValue: false) this.isVerified,
      @JsonKey(name: 'description', defaultValue: '') this.description,
      @JsonKey(name: 'price_change_24h', defaultValue: 0) this.priceChange24h,
      @JsonKey(name: 'standard', defaultValue: '') this.standard,
...
abstract class _LatestToken implements LatestToken {
  const factory _LatestToken(
      ...
      @JsonKey(name: 'volume_24h', defaultValue: 0) final double? volume24h,
      @JsonKey(name: 'market_cap', defaultValue: 0) final double? marketCap,
      @JsonKey(name: 'price_usd', defaultValue: 0) final double? priceUsd,
      @JsonKey(name: 'is_verified', defaultValue: false) final bool? isVerified,
      @JsonKey(name: 'description', defaultValue: '') final String? description,
      @JsonKey(name: 'price_change_24h', defaultValue: 0)
      final double? priceChange24h,
