...
class _$SignInStateImpl implements _SignInState {
  ...
  @override
  String toString() {
    return 'SignInState(email: $email, password: $password, isLoading: $isLoading, isSuccess: $isSuccess, message: $message, errorCode: $errorCode, emailError: $emailError, passwordError: $passwordError)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, email, password, isLoading,
      isSuccess, message, errorCode, emailError, passwordError);
...
abstract class _SignInState implements SignInState {
  const factory _SignInState(
      ...
      final String? errorCode,
      final ValidationError? emailError,
      final ValidationError? passwordError}) = _$SignInStateImpl;
