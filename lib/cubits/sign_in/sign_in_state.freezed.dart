...
switch (_that) {
case _SignInState():
return $default(_that.inviteCode,_that.paymentPin,_that.email,_that.verificationCode,_that.status,_that.nicknameStatus,_that.paymentPinStatus,_that.inviteCodeStatus);}
}
