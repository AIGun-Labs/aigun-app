...
part 'routes/add_token_route.dart';
part 'routes/ai_agent_route.dart';
part 'routes/claim_funds_route.dart';
part 'routes/login_route.dart';
part 'routes/query_token_route.dart';
part 'routes/receive_address_route.dart';
part 'routes/select_network_route.dart';
part 'routes/send_confirm_again_route.dart';
part 'routes/send_select_token_route.dart';
part 'routes/send_token_detail_route.dart';
part 'routes/send_token_route.dart';
part 'routes/splash_route.dart';
part 'routes/switch_language_route.dart';
part 'routes/tabbar_route.dart';
part 'routes/token_detail_route.dart';
part 'routes/trade_confirm_route.dart';
part 'routes/trade_setting_route.dart';
part 'routes/webview_preview_route.dart';
